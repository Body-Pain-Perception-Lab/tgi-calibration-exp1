function TrialTGI(comPort,measure,speed_ramp,stimulus_targetT,~,ntrials,peak_duration,iti,save_file)
%% Example
%TrialTGI(comPort,measure,speed_ramp,stimulus_targetT,threshold_targetT,ntrials,peak_duration,iti,save_file)
%% Parameters
