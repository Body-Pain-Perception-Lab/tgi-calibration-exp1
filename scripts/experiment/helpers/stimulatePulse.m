function [stimTime,stimOn, stimOff, tcsData] = stimulatePulse(Results,scr,vars,keys,type,duration,varargin)
...
while toc(stimTime) <= duration % get tcs data for a predefined amount of time
    ...
    %     time_array (Results.timepoint) = toc(vars.control.stimTime);
