...
%Trials
vars.task.NTrialsTotal       = 10; %50 % Total number of trials (It DOES include the habituation trials), so the total number of trials in Psi is this value subtracted by vars.task.NTrialsHab 
...
switch vars.control.language
    ...
    case 2 %Danish
        ...
        vars.instructions.Question = {'KOLDE?\n \n \n JA - (V)                          NEJ - (H)',...
                                       'VARME-(O)\n \n \n \n \n \n Overvejende? \n \n \n \n \n \n KOLDE - (N)',...
