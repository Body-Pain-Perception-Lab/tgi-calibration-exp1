...
% Part 2: Cold Pain Thresholding (Psi)
%
...
vars.task.Tmax               = 44;   % Highest temperature limit 
...
% Sequence
vars.task.TrialStimArray     = [0];% 0=cold, 1=warm, 2=TGI
...
switch vars.control.language
    case 1 %English
        ...
        vars.instructions.Question = {'COLD?\n \n \n YES - (L)                          NO - (R)',...
                                       'WARM-(U)\n \n \n \n \n \n Predominant? \n \n \n \n \n \n COLD - (D)',...
