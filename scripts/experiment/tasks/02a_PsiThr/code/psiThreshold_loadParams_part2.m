...
% Part 2: Cold/Warm Pain Thresholding (Psi)
%
...
%Trials
vars.task.NTrialsTotal       = 50; % Total number of trials (It DOES include the habituation trials), so the total number of trials in Psi is this value subtracted by vars.task.NTrialsHab 
